...
(function(window) {
    ...
    var ISFValidation = {
        ...
        displayErrors: function(form, errors) {
            ...
            form.querySelectorAll('.isf-field-error').forEach(function(el) {
                el.remove();
            });
            form.querySelectorAll('.isf-input-error').forEach(function(el) {
                el.classList.remove('isf-input-error');
            });
            ...
            Object.keys(errors).forEach(function(fieldName) {
                ...
                field.classList.add('isf-input-error');

                var errorEl = document.createElement('p');
                errorEl.className = 'isf-field-error';
                errorEl.textContent = errors[fieldName];

                var parent = field.closest('.isf-field');
                if (parent) {
