...
class Hooks {
     ...
     * });
     */
    public const REGISTER_CONNECTORS = 'isf_register_connectors';
     ...
     */
    public const CONNECTORS_LOADED = 'isf_connectors_loaded';
     ...
     */
    public const CONNECTOR_REGISTERED = 'isf_connector_registered';
     ...
     */
    public const REGISTERED_CONNECTORS = 'isf_registered_connectors';
     ...
     */
    public const DEFAULT_CONNECTOR = 'isf_default_connector';
     ...
     */
    public const BRANDING_SETTINGS = 'isf_branding_settings';
     ...
     */
    public const BRANDING_CSS = 'isf_branding_css';
     ...
     */
    public const FORM_CONFIG = 'isf_form_config';
     ...
     */
    public const FORM_DATA = 'isf_form_data';
     ...
     * @param int $instance_id Instance ID
     */
    public const BEFORE_STEP = 'isf_before_step';
     ...
     * @param int $instance_id Instance ID
     */
    public const AFTER_STEP = 'isf_after_step';
     ...
     */
    public const VALIDATE_STEP = 'isf_validate_step';
     ...
     * @return array Modified data
     */
    public const ENROLLMENT_DATA = 'isf_enrollment_data';
     ...
     */
    public const ENROLLMENT_COMPLETED = 'isf_enrollment_completed';
     ...
     */
    public const ENROLLMENT_FAILED = 'isf_enrollment_failed';
     ...
     */
    public const ACCOUNT_VALIDATED = 'isf_account_validated';
     ...
     */
    public const SCHEDULE_SLOTS = 'isf_schedule_slots';
     ...
     */
    public const APPOINTMENT_BOOKED = 'isf_appointment_booked';
     ...
     */
    public const APPOINTMENT_CANCELLED = 'isf_appointment_cancelled';
     ...
     */
    public const APPOINTMENT_RESCHEDULED = 'isf_appointment_rescheduled';
     ...
     */
    public const CONFIRMATION_EMAIL_CONTENT = 'isf_confirmation_email_content';
     ...
     */
    public const EMAIL_HEADERS = 'isf_email_headers';
     ...
     */
    public const SMS_MESSAGE = 'isf_sms_message';
     ...
     */
    public const BEFORE_NOTIFICATION = 'isf_before_notification';
     ...
     */
    public const AFTER_NOTIFICATION = 'isf_after_notification';
     ...
     */
    public const WEBHOOK_PAYLOAD = 'isf_webhook_payload';
     ...
     */
    public const WEBHOOK_DELIVERED = 'isf_webhook_delivered';
     ...
     */
    public const ADMIN_MENU_ITEMS = 'isf_admin_menu_items';
     ...
     */
    public const SETTINGS_SAVED = 'isf_settings_saved';
     ...
     * @return array Modified settings
     */
    public const INSTANCE_SETTINGS = 'isf_instance_settings';
     ...
     */
    public const AVAILABLE_FEATURES = 'isf_available_features';
     ...
     */
    public const FEATURE_ENABLED = 'isf_feature_enabled';
     ...
     * @param int $instance_id Instance ID
     */
    public const FEATURE_TOGGLED = 'isf_feature_toggled';
     ...
     */
    public const FRAUD_RISK_SCORE = 'isf_fraud_risk_score';
     ...
     */
    public const FRAUD_DETECTED = 'isf_fraud_detected';
     ...
     */
    public const RATE_LIMIT = 'isf_rate_limit';
     ...
     * @return array Modified data
     */
    public const BEFORE_SAVE_SUBMISSION = 'isf_before_save_submission';
     ...
     * @param array $data Submission data
     */
    public const AFTER_SAVE_SUBMISSION = 'isf_after_save_submission';
     ...
     */
    public const EXPORT_COLUMNS = 'isf_export_columns';
     ...
     */
    public const UTM_CAPTURED = 'isf_utm_captured';
     ...
     */
    public const FORM_VIEWED = 'isf_form_viewed';
     ...
     *   - status: string
     */
    public const FORM_COMPLETED = 'isf_form_completed';
     ...
     */
    public const FORM_STEP_COMPLETED = 'isf_form_step_completed';
     ...
     */
    public const VISITOR_IDENTIFIED = 'isf_visitor_identified';
     ...
     */
    public const HANDOFF_REDIRECT = 'isf_handoff_redirect';
     ...
     */
    public const EXTERNAL_COMPLETION = 'isf_external_completion';
     ...
     */
    public const GET_VISITOR_ID = 'isf_get_visitor_id';
     ...
     */
    public const SANITIZE_FIELDS = 'isf_sanitize_fields';
     ...
     */
    public const CHECK_RATE_LIMIT = 'isf_check_rate_limit';
