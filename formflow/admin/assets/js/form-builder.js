    ...
    class FormBuilder {
        ...
        initDragDrop() {
            ...
            this.container.find('.isf-step-content').on('dragover', function(e) {
                ...
                self.container.find('.isf-drop-indicator').remove();
                const $indicator = $('<div class="isf-drop-indicator"></div>');
            ...
            this.container.find('.isf-step-content').sortable({
                handle: '.isf-field-drag-handle',
                placeholder: 'isf-field-placeholder',
                tolerance: 'pointer',
                cursor: 'grabbing',
                opacity: 0.8,
                items: '.isf-canvas-field',
