...
class Branding {
    ...
    private function load_settings(): void {
         ...
         */
        $this->settings = apply_filters('isf_branding_settings', $this->settings);
    }
    ...
    public function save(): bool {
        return update_option('isf_branding', $this->settings);
    }
    ...
    public function get_custom_css(): string {
        ...
        return "
            :root {
                --isf-primary-color: {$primary};
                --isf-secondary-color: {$secondary};
                --isf-accent-color: {$accent};
            }
            .isf-btn-primary { background-color: {$primary}; }
            .isf-btn-primary:hover { background-color: color-mix(in srgb, {$primary} 85%, black); }
            .isf-progress-bar .isf-progress-fill { background-color: {$primary}; }
            .isf-step.active .isf-step-number { background-color: {$primary}; }
            .isf-link { color: {$primary}; }
        ";
    }
    ...
    public static function get_field_definitions(): array {
        return [
            'identity' => [
                'label' => __('Plugin Identity', 'formflow'),
                'fields' => [
                    'plugin_name' => [
                        'label' => __('Plugin Name', 'formflow'),
                        'type' => 'text',
                        'description' => __('The main name displayed in the admin menu and throughout the plugin', 'formflow'),
                    ],
                    'plugin_short_name' => [
                        'label' => __('Short Name', 'formflow'),
                        'type' => 'text',
                        'description' => __('Abbreviated name for compact displays', 'formflow'),
                    ],
                    'plugin_description' => [
                        'label' => __('Description', 'formflow'),
                        'type' => 'textarea',
                        'description' => __('Brief description of what the plugin does', 'formflow'),
                    ],
                ],
            ],
            'company' => [
                'label' => __('Company Information', 'formflow'),
                'fields' => [
                    'company_name' => [
                        'label' => __('Company Name', 'formflow'),
                        'type' => 'text',
                    ],
                    'company_url' => [
                        'label' => __('Company Website', 'formflow'),
                        'type' => 'url',
                    ],
                    'support_email' => [
                        'label' => __('Support Email', 'formflow'),
                        'type' => 'email',
                    ],
                    'support_url' => [
                        'label' => __('Support URL', 'formflow'),
                        'type' => 'url',
                    ],
                ],
            ],
            'visual' => [
                'label' => __('Visual Branding', 'formflow'),
                'fields' => [
                    'primary_color' => [
                        'label' => __('Primary Color', 'formflow'),
                        'type' => 'color',
                        'description' => __('Main brand color for buttons and accents', 'formflow'),
                    ],
                    'secondary_color' => [
                        'label' => __('Secondary Color', 'formflow'),
                        'type' => 'color',
                    ],
                    'accent_color' => [
                        'label' => __('Accent Color', 'formflow'),
                        'type' => 'color',
                    ],
                    'logo_url' => [
                        'label' => __('Logo URL', 'formflow'),
                        'type' => 'url',
                        'description' => __('Full URL to your logo image', 'formflow'),
                    ],
                    'menu_icon' => [
                        'label' => __('Admin Menu Icon', 'formflow'),
                        'type' => 'text',
                        'description' => __('Dashicon class (e.g., dashicons-feedback) or image URL', 'formflow'),
                    ],
                ],
            ],
            'text' => [
                'label' => __('Text Customization', 'formflow'),
                'fields' => [
                    'form_title' => [
                        'label' => __('Default Form Title', 'formflow'),
                        'type' => 'text',
                    ],
                    'form_subtitle' => [
                        'label' => __('Default Form Subtitle', 'formflow'),
                        'type' => 'text',
                    ],
                    'success_title' => [
                        'label' => __('Success Page Title', 'formflow'),
                        'type' => 'text',
                    ],
                    'success_message' => [
                        'label' => __('Success Message', 'formflow'),
                        'type' => 'textarea',
                    ],
                ],
            ],
            'attribution' => [
                'label' => __('Attribution', 'formflow'),
                'fields' => [
                    'show_powered_by' => [
                        'label' => __('Show "Powered By"', 'formflow'),
                        'type' => 'checkbox',
                    ],
                    'powered_by_text' => [
                        'label' => __('Powered By Text', 'formflow'),
                        'type' => 'text',
                    ],
                    'powered_by_url' => [
                        'label' => __('Powered By URL', 'formflow'),
                        'type' => 'url',
                    ],
                ],
            ],
            'email' => [
                'label' => __('Email Branding', 'formflow'),
                'fields' => [
                    'email_from_name' => [
                        'label' => __('Email From Name', 'formflow'),
                        'type' => 'text',
                    ],
                    'email_logo_url' => [
                        'label' => __('Email Logo URL', 'formflow'),
                        'type' => 'url',
                    ],
                    'email_footer_text' => [
                        'label' => __('Email Footer Text', 'formflow'),
                        'type' => 'textarea',
                    ],
                ],
            ],
 ...
 * @return Branding
 */
function isf_branding(): Branding {
