...
class IntelliSourceFieldMapper {
    ...
    public static function validate_account_for_utility(string $account_number, string $utility): array {
        ...
        if (strpos(strtolower($utility), 'delmarva') !== false) {
            if (strlen($account) === 10) {
                $errors[] = [
                    'code' => 'pepco_account',
                    'message' => __("This appears to be a Pepco account number. Please visit the Pepco enrollment page.", 'formflow'),
                ];
            }
        }
        ...
        if (strpos(strtolower($utility), 'pepco') !== false) {
            if (strlen($account) !== 10) {
                $errors[] = [
                    ...
                    'message' => __("This appears to be a Delmarva Power account number. Please visit the Delmarva enrollment page.", 'formflow'),
                ];
            }
        }
    ...
    public static function get_field_label(string $api_field): string {
        $labels = [
            'accountnumber' => __('Account Number', 'formflow'),
            'utility_no' => __('Account Number', 'formflow'),
            'level' => __('Participation Level', 'formflow'),
            'fname' => __('First Name', 'formflow'),
            'lname' => __('Last Name', 'formflow'),
            'address' => __('Street Address', 'formflow'),
            'address2' => __('Address Line 2', 'formflow'),
            'city' => __('City', 'formflow'),
            'state' => __('State', 'formflow'),
            'zip' => __('ZIP Code', 'formflow'),
            'dayPhone' => __('Primary Phone', 'formflow'),
            'evePhone' => __('Secondary Phone', 'formflow'),
            'email' => __('Email Address', 'formflow'),
            'ownsPrem' => __('Lease or Own', 'formflow'),
            'eqCount-15' => __('Number of Thermostats/Units', 'formflow'),
            'pCode' => __('Promo Code', 'formflow'),
            'schedule_date' => __('Appointment Date', 'formflow'),
            'time' => __('Appointment Time', 'formflow'),
            'contract' => __('Contract Type', 'formflow'),
        ];
